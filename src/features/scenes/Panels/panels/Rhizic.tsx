...
export function Rhizic() {
    ...
    return <div className="w-full h-full text-4xl font-bold font-[Book_Antiqua]">
...
export function RhizicAdmin() {
    return <div className='w-120 h-20 overflow-y-scroll px-2 border'>
        can't get break par at mini-golf<br />
        ...
        God keeps calling to tell you about the punishments your sins, but Jesus keeps butting in to forgive them<br />
